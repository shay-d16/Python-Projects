...
#
# Purpose: Create a basic phone book application using Sqlite3 user information
#
#
...
class ParentWindow(Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        self.master = master #'self' is simply saying our ParentWindow.
                             #'.master' is the ParentWindow Frame
